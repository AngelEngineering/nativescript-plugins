import { EventData, Page, File, Frame, StackLayout, Color, Label, Image, alert, isAndroid, Device, knownFolders } from '@nativescript/core';
...
export class DemoModel extends DemoSharedFilepicker {
  ...
  async pickVideo() {
    ...
    try {
      let tempPath = knownFolders.temp().path;
